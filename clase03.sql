...
-- Solo puede haber una única PK por tabla, pero esta puede ser compuesta. Eso significa que está compuesta por más de una tabla. 
-- Por ejemplo (letra, numero)
-- cada campo por si solo no es una clave ni tampoco identifica al registro, pero la suma de las dos, forman la clave.
